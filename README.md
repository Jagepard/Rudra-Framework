...
For CLI commands (like `php rudra migrate`), the framework cannot auto-detect the environment. It relies on the `app_env.php` file, which is automatically generated by Composer during project installation.
...
##### Setup
After installation, simply open the generated `app_env.php` file in your project root and set your environment:
```php
<?php
